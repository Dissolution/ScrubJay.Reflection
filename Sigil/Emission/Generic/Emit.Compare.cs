...
public partial class Emit<TDelegateType>
{
    ...
    /// </summary>
    public Emit<TDelegateType> CompareEqual()
    {
        var transitions =
            new[]
            {
    ...
    /// New value on the stack is an Int32.
    /// </summary>
    public Emit<TDelegateType> CompareGreaterThan()
    {
    ...
    /// New value on the stack is an Int32.
    /// </summary>
    public Emit<TDelegateType> UnsignedCompareGreaterThan()
    {
    ...
    /// New value on the stack is an Int32.
    /// </summary>
    public Emit<TDelegateType> CompareLessThan()
    {
    ...
    /// New value on the stack is an Int32.
    /// </summary>
    public Emit<TDelegateType> UnsignedCompareLessThan()
    {
