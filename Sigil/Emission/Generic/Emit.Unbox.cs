...
public partial class Emit<TDelegateType>
{
    ...
    /// </summary>
    public Emit<TDelegateType> Unbox<TValueType>()
    {
    ...
    /// To load the value directly onto the stack, use UnboxAny().
    /// </summary>
    public Emit<TDelegateType> Unbox(Type valueType)
    {
        if (valueType == null)
        {
    ...
    /// </summary>
    public Emit<TDelegateType> UnboxAny<TValueType>()
    {
        return UnboxAny(typeof(TValueType));
    }
    ...
    /// To get an address for the unboxed value instead, use Unbox().
    /// </summary>
    public Emit<TDelegateType> UnboxAny(Type valueType)
    {
        if (valueType == null)
        {
            throw new ArgumentNullException("valueType");
