...
public partial class Emit<TDelegateType>
{
    ...
    /// </summary>
    public Emit<TDelegateType> Convert<TPrimitiveType>()
        where TPrimitiveType : struct
    {
        return Convert(typeof(TPrimitiveType));
    }
    ...
    /// Primitives are int8, uint8, int16, uint16, int32, uint32, int64, uint64, float, double, native int (IntPtr), and unsigned native int (UIntPtr).
    /// </summary>
    public Emit<TDelegateType> Convert(Type primitiveType)
    {
    ...
    /// Primitives are int8, uint8, int16, uint16, int32, uint32, int64, uint64, float, double, native int (IntPtr), and unsigned native int (UIntPtr).
    /// </summary>
    public Emit<TDelegateType> ConvertOverflow<TPrimitiveType>()
    {
        return ConvertOverflow(typeof(TPrimitiveType));
    }
    ...
    /// Primitives are int8, uint8, int16, uint16, int32, uint32, int64, uint64, float, double, native int (IntPtr), and unsigned native int (UIntPtr).
    /// </summary>
    public Emit<TDelegateType> ConvertOverflow(Type primitiveType)
    {
        if (primitiveType == null)
        {
            throw new ArgumentNullException("primitiveType");
    ...
    /// Primitives are int8, uint8, int16, uint16, int32, uint32, int64, uint64, float, double, native int (IntPtr), and unsigned native int (UIntPtr).
    /// </summary>
    public Emit<TDelegateType> UnsignedConvertOverflow<TPrimitiveType>()
    {
        return UnsignedConvertOverflow(typeof(TPrimitiveType));
    }
    ...
    /// Primitives are int8, uint8, int16, uint16, int32, uint32, int64, uint64, float, double, native int (IntPtr), and unsigned native int (UIntPtr).
    /// </summary>
    public Emit<TDelegateType> UnsignedConvertOverflow(Type primitiveType)
    {
        if (primitiveType == null)
        {
            throw new ArgumentNullException("primitiveType");
    ...
    /// Primitives are int8, uint8, int16, uint16, int32, uint32, int64, uint64, float, double, native int (IntPtr), and unsigned native int (UIntPtr).
    /// </summary>
    public Emit<TDelegateType> UnsignedConvertToFloat()
    {
