...
internal static class LinqAlternative
{
    ...
    private sealed class Grouping<TK, TV> : IGrouping<TK, TV>
    {
    ...
    public static IEnumerable<TV> _Select<T, TV>(IEnumerable<T> e, Func<T, TV> p)
    {
        using (var i = e.GetEnumerator())
        {
            while (i.MoveNext())
    ...
    public static LinqRoot<TV> Select<T, TV>(IEnumerable<T> e, Func<T, TV> p)
    {
        if (e == null) throw new ArgumentNullException("e");
        if (p == null) throw new ArgumentNullException("p");

        return LinqEnumerable<TV>.For(_Select(e, p));
    }

    public static IEnumerable<TV> _Select<T, TV>(IEnumerable<T> e, Func<T, int, TV> p)
    {
        using (var i = e.GetEnumerator())
        {
            var x = 0;
    ...
    public static LinqRoot<TV> Select<T, TV>(IEnumerable<T> e, Func<T, int, TV> p)
    {
        if (e == null) throw new ArgumentNullException("e");
        if (p == null) throw new ArgumentNullException("p");
    ...
    public static LinqDictionary<TKey, TValue> ToDictionary<T, TKey, TValue>(IEnumerable<T> e, Func<T, TKey> k, Func<T, TValue> v)
    {
        if (e == null) throw new ArgumentNullException("e");
        if (k == null) throw new ArgumentNullException("k");
        if (v == null) throw new ArgumentNullException("v");

        var ret = new LinqDictionary<TKey, TValue>();
    ...
    {
        var reversed = new LinqStack<T>(e);
    ...
    public static TV Aggregate<T, TV>(IEnumerable<T> e, TV seed, Func<TV, T, TV> a)
    {
        if (e == null) throw new ArgumentNullException("e");
        if (a == null) throw new ArgumentNullException("a");
    ...
    */
    ...
    private static IEnumerable<TV> _SelectMany<T, TV>(IEnumerable<T> e, Func<T, IEnumerable<TV>> p)
    {
        using (var i = e.GetEnumerator())
        {
            while (i.MoveNext())
    ...
    public static IEnumerable<TV> SelectMany<T, TV>(IEnumerable<T> e, Func<T, IEnumerable<TV>> p)
    {
        if (e == null) throw new ArgumentNullException("e");
        if (p == null) throw new ArgumentNullException("p");
    ...
    public static LinqRoot<IGrouping<TK, T>> GroupBy<T, TK>(IEnumerable<T> e, Func<T, TK> p)
    {
        if (e == null) throw new ArgumentNullException("e");
        if (p == null) throw new ArgumentNullException("p");

        var ret = new LinqList<IGrouping<TK, T>>();
        var gLookup = new Dictionary<TK, Grouping<TK, T>>();
        ...
        using (var i = e.GetEnumerator())
        {
            while (i.MoveNext())
            {
                ...
                {
                    gLookup[k] = g = new Grouping<TK, T>(k);
    ...
    private static IEnumerable<T> _QuickSort<T, TV>(T[] data, int[] ixs, TV[] keys, IComparer<TV> c)
    {
        var nextYield = 0;

        var stack = new LinqStack<Tuple<int, int>>();
    ...
    private static int _Partition<TV>(int[] ixs, TV[] keys, int left, int right, int pivot, IComparer<TV> c)
    {
    ...
    private static IEnumerable<T> _Order<T, TV>(IEnumerable<T> e, Func<T, TV> p, IComparer<TV> c)
    {
        var data = ToArray(e);
    ...
    public static LinqRoot<T> OrderBy<T, TV>(IEnumerable<T> e, Func<T, TV> p)
    {
        if (e == null) throw new ArgumentNullException("e");
        if (p == null) throw new ArgumentNullException("p");

        return LinqEnumerable<T>.For(_Order(e, p, Comparer<TV>.Default));
    }

    public static LinqRoot<T> OrderByDescending<T, TV>(IEnumerable<T> e, Func<T, TV> p)
    {
        if (e == null) throw new ArgumentNullException("e");
        if (p == null) throw new ArgumentNullException("p");

        return LinqEnumerable<T>.For(_Order(e, p, DescendingComparer<TV>.Default));
    }
