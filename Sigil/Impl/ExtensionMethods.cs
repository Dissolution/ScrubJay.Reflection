...
internal static class ExtensionMethods
{
    ...
    private static readonly Dictionary<Type, Type> _aliasCache = new Dictionary<Type, Type>
    {
    ...
    private static bool ReallyIsAssignableFrom(Type t1, Type t2)
    {
        ...
        if((t1 == typeof(object) || t1.IsInterface) && t2.IsValueType) return false;
        ...
        if (t1.IsInterface)
        {
            var t2Interfaces = t2.IsPointer ? t2.GetElementType().GetInterfaces() : t2.GetInterfaces();
