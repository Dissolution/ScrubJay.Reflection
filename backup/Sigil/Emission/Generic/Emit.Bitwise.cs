...
public partial class Emit<TDelegateType>
{
    ...
    /// </summary>
    public Emit<TDelegateType> ShiftLeft()
    {
    ...
    /// </summary>
    public Emit<TDelegateType> ShiftRight()
    {
    ...
    /// </summary>
    public Emit<TDelegateType> UnsignedShiftRight()
    {
