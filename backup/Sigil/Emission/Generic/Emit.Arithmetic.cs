...
public partial class Emit<TDelegateType>
{
    ...
    /// </summary>
    public Emit<TDelegateType> AddOverflow()
    {
    ...
    /// Throws an OverflowException if the result overflows the destination type.
    /// </summary>
    public Emit<TDelegateType> UnsignedAddOverflow()
    {
    ...
    /// </summary>
    public Emit<TDelegateType> Divide()
    {
    ...
    /// </summary>
    public Emit<TDelegateType> UnsignedDivide()
    {
    ...
    /// </summary>
    public Emit<TDelegateType> Multiply()
    {
    ...
    /// Throws an OverflowException if the result overflows the destination type.
    /// </summary>
    public Emit<TDelegateType> MultiplyOverflow()
    {
    ...
    /// Throws an OverflowException if the result overflows the destination type.
    /// </summary>
    public Emit<TDelegateType> UnsignedMultiplyOverflow()
    {
    ...
    /// </summary>
    public Emit<TDelegateType> Remainder()
    {
    ...
    /// </summary>
    public Emit<TDelegateType> UnsignedRemainder()
    {
    ...
    /// </summary>
    public Emit<TDelegateType> Subtract()
    {
    ...
    /// Throws an OverflowException if the result overflows the destination type.
    /// </summary>
    public Emit<TDelegateType> SubtractOverflow()
    {
    ...
    /// Throws an OverflowException if the result overflows the destination type.
    /// </summary>
    public Emit<TDelegateType> UnsignedSubtractOverflow()
    {
    ...
    /// </summary>
    public Emit<TDelegateType> Negate()
    {
        var transitions =
            new[]
            {
