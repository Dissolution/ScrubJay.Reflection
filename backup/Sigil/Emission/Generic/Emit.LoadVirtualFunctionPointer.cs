...
public partial class Emit<TDelegateType>
{
    ...
    /// </summary>
    public Emit<TDelegateType> LoadVirtualFunctionPointer(MethodInfo method)
    {
        if (method == null)
        {
    ...
    /// </summary>
    public Emit<TDelegateType> LoadVirtualFunctionPointer(MethodBuilder method, Type[] parameterTypes)
    {
        if (method == null)
        {
    ...
    Emit<TDelegateType> InnerLoadVirtualFunctionPointer(MethodInfo method, Type[] parameterTypes)
    {
        var thisType =
