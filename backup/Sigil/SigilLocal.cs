...
/// </summary>
public class SigilLocal : IOwned, IDisposable
{
    /// <summary>
    ...
    internal DeclareLocalDelegate LocalDel { get; private set; }
    ...
    internal SigilLocal(object owner, ushort index, Type localType, DeclareLocalDelegate local, string name, LocalReusableDelegate reusable, int declaredAt)
    {
        _owner = owner;
        LocalDel = local;
        Name = name;
