...
using ScrubJay.Reflection.OLD.OLD.Runtime.Emission;
using ScrubJay.Reflection.OLD.OLD.Runtime.Emission.Emitters;
using ScrubJay.Reflection.OLD.OLD.Runtime.Naming;
using ScrubJay.Reflection.OLD.OLD.Searching;
...
public static class RuntimeBuilder
{
    ...
    static RuntimeBuilder()
    {
        ...
        ModuleBuilder = AssemblyBuilder.DefineDynamicModule(nameof(Reflection.Runtime));
    }

    public static string GetRuntimeMemberName() => throw new NotImplementedException();
