...
public sealed class MirrorMethodBases : MirrorMethodBaseBuilder<MirrorMethodBases, MethodBase>
{
    public MirrorMethodBases(Type reflectedType, IEnumerable<MethodBase> members) 
