...
public interface IGeneratorEmitter<TEmitter> : IILEmitter<TEmitter>
    where TEmitter : IGeneratorEmitter<TEmitter>
{
#region try/catch/finally
    ...
    /// </param>
    /// <param name="lblName">Automatically captured name for the <see cref="EmitterLabel"/></param>
    /// <links>
    ...
    /// </links>
    TEmitter BeginExceptionBlock(out EmitterLabel label, [CallerArgumentExpression(nameof(label))] string lblName = "");
...
#region Locals
    ...
    /// </links>
    TEmitter DeclareLocal(Type localType, out EmitterLocal local, [CallerArgumentExpression(nameof(local))] string localName = "");
    ...
    /// <a href="https://learn.microsoft.com/en-us/dotnet/api/system.reflection.emit.ilgenerator.declarelocal?view=net-8.0#system-reflection-emit-ilgenerator-declarelocal(system-type)">learn.microsoft.com</a>
    /// </links>
    TEmitter DeclareLocal<T>(out EmitterLocal local, [CallerArgumentExpression(nameof(local))] string localName = "");
    ...
    /// </links>
    TEmitter DeclareLocal(Type localType, bool pinned, out EmitterLocal local, [CallerArgumentExpression(nameof(local))] string localName = "");
    ...
    /// <a href="https://learn.microsoft.com/en-us/dotnet/api/system.reflection.emit.ilgenerator.declarelocal?view=net-8.0#system-reflection-emit-ilgenerator-declarelocal(system-type-system-boolean)">learn.microsoft.com</a>
    /// </links>
    TEmitter DeclareLocal<T>(bool pinned, out EmitterLocal local, [CallerArgumentExpression(nameof(local))] string localName = "");
#endregion
#region Labels
    /// <summary>
    ...
    /// </links>
    TEmitter DefineLabel(out EmitterLabel label, [CallerArgumentExpression(nameof(label))] string labelName = "");
