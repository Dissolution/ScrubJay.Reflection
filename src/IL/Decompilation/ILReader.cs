...
//
//public sealed class ILReader : IEnumerable<OpCodeInstruction>, IEnumerable
//{
...
//
//    public ILReader(byte[] ilBytes, ITokenResolver tokenResolver)
//    {
...
//
//
//    public IEnumerator<OpCodeInstruction> GetEnumerator()
//    {
...
//
//    private OpCodeInstruction Next()
//    {
...
//        if (code != 0xFE)
//        {
//            opCode = OpCoding._oneByteOpCodes[code];
//        }
//        else
//        {
//            code = ReadByte();
//            opCode = OpCoding._twoByteOpCodes[code];
//        }
//
...
//                token = ReadInt32();
//                return new InlineFieldInstruction(offset, opCode, token, Resolver);
//
//            //The operand is a 32-bit metadata token.
